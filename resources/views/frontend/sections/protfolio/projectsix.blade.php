      ...
      <section class="max-w-7xl mx-auto px-5 sm:px-8 mb-24">
        <div class="grid lg:grid-cols-12 gap-8 items-start">
          <div class="lg:col-span-5 lg:sticky lg:top-28 lg:order-2" data-reveal>
            ...
            <a href="https://waticrm.in/" target="_blank" rel="noopener" class="btn-acid inline-flex items-center gap-2 px-6 py-3 rounded-full font-semibold mt-7" data-testid="project-svastam-link" data-cursor>Visit live
          ...
          <div class="lg:col-span-7 lg:order-1" data-reveal>
            <div class="panel overflow-hidden">
              <div class="flex items-center gap-3 px-4 py-3 border-b border-white/8">
                ...
                <div class="flex-1 text-center font-mono text-[11px] text-muted truncate">waticrm.in</div>
              </div>
              <div class="shot-frame" data-testid="project-svastam-shot">
                <img src="{{asset('assets/Screenshot 2026-07-30 at 20-56-53 WatiCRM by Genius IT Solutions - Powerful WhatsApp Marketing Software.png')}}" alt="">
