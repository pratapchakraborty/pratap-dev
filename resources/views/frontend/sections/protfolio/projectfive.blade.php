      ...
      <section class="max-w-7xl mx-auto px-5 sm:px-8 mb-24">
        <div class="grid lg:grid-cols-12 gap-8 items-start">
          <div class="lg:col-span-5 lg:sticky lg:top-28" data-reveal>
            ...
            <a href="https://digitalvcard.online/" target="_blank" rel="noopener" class="btn-acid inline-flex items-center gap-2 px-6 py-3 rounded-full font-semibold mt-7" data-testid="project-svastam-link" data-cursor>Visit live
          ...
          <div class="lg:col-span-7" data-reveal>
            <div class="panel overflow-hidden">
              ...
              <div class="shot-frame" data-testid="project-svastam-shot">
                <img src="{{asset('assets/Screenshot 2026-07-30 at 20-34-24 Digital Visiting Card - Digital Business Card Check Your Free Demo.png')}}" alt="">
